...
I am **Junteng Liu**, a first-year PhD candidate at the HKUST NLP Group, Hong Kong University of Science and Technology (HKUST), where I am supervised by Professor Junxian He. I graduated from Shanghai Jiao Tong University (SJTU) in June 2024, and Professor Junxian He also previously advised me during my undergraduate studies at SJTU.
...
Publications
======
My publications are also listed on the [Publications]({{ '/publications/' | relative_url }}) page and on my [Google Scholar profile](https://scholar.google.com/citations?hl=en&user=tbK9jl4AAAAJ&view_op=list_works&sortby=pubdate).

**2025**

1. [**SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond**]({{ '/publication/synlogic/' | relative_url }})  
...
2. [**On the Perception Bottleneck of VLMs for Chart Understanding**]({{ '/publication/perception-bottleneck-vlms-chart/' | relative_url }})  
   **Junteng Liu**, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. *Arxiv*, 2025. (First author)

**2024**

3. [**On the Universal Truthfulness Hyperplane Inside LLMs**]({{ '/publication/universal-truthfulness-hyperplane/' | relative_url }})  
   **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He. *EMNLP 2024*. (First author)

4. [**In-Context Sharpness as Alerts: An Inner Representation Perspective for Hallucination Mitigation**]({{ '/publication/in-context-sharpness/' | relative_url }})  
   Shiqi Chen, Miao Xiong, **Junteng Liu**, Zhengxuan Wu, Teng Xiao, Siyang Gao, Junxian He. *ICML 2024*.

**2023**

5. [**C-Eval: A Multi-Level Multi-Discipline Chinese Evaluation Suite for Foundation Models**]({{ '/publication/c-eval/' | relative_url }})  
...
6. [**Composing Parameter-Efficient Modules with Arithmetic Operations**]({{ '/publication/composing-parameter-efficient-modules/' | relative_url }})  
